...
public class Povray3DScene implements Serializable {
	...
	private void initializeScene() {
		...
		// FLANN change camera to +1.5 x
		if (_domain.is3D){
			_camera.setLocation(0, _y*1.3, +_x*1.5);
	...
	//Revision 2; Farzin
	public File writeModelStateForTuring(String fileName) throws IOException {
		_biofilm = new Biofilm3D(this);
		...
		try {
			_biofilm.turingParticlesToFile(fr);
		} catch(Exception e) {
			_biofilm.turingParticlesToFile(fr);
		}
