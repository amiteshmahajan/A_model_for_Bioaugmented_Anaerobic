...
//		_genealogy  = Integer.parseInt(singleAgentData[1]);
//		_generation = Integer.parseInt(singleAgentData[2]);
//		_birthday   = Double.parseDouble(singleAgentData[3]);
        _family     = Integer.parseInt(singleAgentData[1]);
        _genealogy  = Integer.parseInt(singleAgentData[2]);
        _generation = Integer.parseInt(singleAgentData[3]);
        _birthday   = Double.parseDouble(singleAgentData[4]);
	...
	public abstract void activationInhibitionOperation();
	...
	public String sendHeader() {
		...
		StringBuffer tempString = new StringBuffer("birthid,family,genealogy,generation,birthday");
	...
	public String writeOutput() {
		...
		tempString.append(_birthId + ","+_family+","+_genealogy+","+_generation+","+_birthday);
		return tempString.toString();
	}
...
//		baby._generation = this._generation;
		...
		baby._generation = this._generation+1;
